...
static const struct ieee80211_regdomain regdom_EU = {
	.alpha2 = "EU",
	.reg_rules = {
		REG_RULE(2400, 2483, 40, 0, 20, 0),
...
static const struct ieee80211_regdomain regdom_XX = {
	...
	.reg_rules = {
		...
		REG_RULE(5470, 5725, 40, 0, 20, 0),
		REG_RULE(5725, 5875, 40, 0, 20, 0),
		REG_RULE(5150, 5250, 20, 0, 20, 0),
		REG_RULE(5250, 5350, 20, 0, 20, 0),
		REG_RULE(5470, 5725, 20, 0, 20, 0),
		REG_RULE(5725, 5875, 20, 0, 20, 0),
	},
	.n_reg_rules = 9
};
